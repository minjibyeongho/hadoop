...
implements Tool{
	...
	public int run(String[] arg0) throws Exception {
		...
		MultipleOutputs.addNamedOutput(conf, "actual", TextOutputFormat.class, Text.class, Text.class);
		MultipleOutputs.addNamedOutput(conf, "CRS", TextOutputFormat.class, Text.class, Text.class);
